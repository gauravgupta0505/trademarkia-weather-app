...
function Inputs({ setQuery, units, setUnits }) {
  ...
  return (
    <div className="flex flex-row justify-center my-6">
      <div className="block sm:flex flex-row w-3/4 items-center justify-center space-x-4">
        <input
          type="text"
          value={city}
        ...
        />
        <div className="flex flex-row mt-5 sm:mt-0 items-center justify-center space-x-9 sm:space-x-4">
          <UilSearch
            size={25}
